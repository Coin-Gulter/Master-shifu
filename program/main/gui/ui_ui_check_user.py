...
################################################################################
## Form generated from reading UI file 'ui_check_user.ui'
##
...
"}")
        ...
        self.page_password_check_enter_password_text_label.setGeometry(QRect(110, 90, 101, 61))
...
"}")
    ...
    def retranslateUi(self, Dialog_user_check):
        ...
        self.page_password_check_enter_password_text_label.setText(QCoreApplication.translate("Dialog_user_check", u"<html><head/><body><p><span style=\" font-size:12pt;\">........./\\.........</span><br><span style=\" font-size:12pt;\">..........|..........</span><br><span style=\" font-size:10pt;\">Enter password</span></p></body></html>", None))
