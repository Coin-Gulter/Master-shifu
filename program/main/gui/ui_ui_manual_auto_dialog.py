...
################################################################################
## Form generated from reading UI file 'ui_manual_auto_dialog.ui'
##
...
class Ui_dialog_hand_auto(object):
    def setupUi(self, dialog_hand_auto):
        ...
        dialog_hand_auto.setMinimumSize(QSize(300, 200))
        dialog_hand_auto.setMaximumSize(QSize(300, 200))
...
"}")
        ...
        self.dialog_hand_auto_text_label.setGeometry(QRect(30, 10, 111, 80))
...
"}")
    ...
    def retranslateUi(self, dialog_hand_auto):
        ...
        self.dialog_hand_auto_auto_button.setText(QCoreApplication.translate("dialog_hand_auto", u"face id", None))
